...
import satella.app.posyanduku.data_pages.sehat_anak.SehatAnakActivity;

public class DataBalitaActivity extends AppCompatActivity implements View.OnClickListener {

    private ImageView imgDataAnak, imgList, imgSehat, imgParent;
    ...
    public void onClick(View v) {
        if (v == imgDataAnak){
            ...
            Intent intent = new Intent(DataBalitaActivity.this, SehatAnakActivity.class);
            startActivity(intent);
        }
    }
}
